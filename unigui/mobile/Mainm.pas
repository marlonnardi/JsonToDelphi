...
begin
  ...
  Confirm.Alert(
    ...
    '<i class=''fab fa-lg fa-github''></i><a href="https://github.com/marlonnardi/JsonToDelphi?tab=readme-ov-file#fixes--features-16th-june-2024" target="_blank"> News Fixes & Features </a> </br></br> '+
